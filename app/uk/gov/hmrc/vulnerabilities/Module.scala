...
import uk.gov.hmrc.vulnerabilities.scheduler.{AddDependencyInfoScheduler, ReloadScheduler, TimelineScheduler, FixNotScannedScheduler}
...
class Module extends play.api.inject.Module:
  ...
  override def bindings(environment: Environment, configuration: Configuration): Seq[Binding[_]] =
    ...
    , bind[AddDependencyInfoScheduler].toSelf.eagerly()
