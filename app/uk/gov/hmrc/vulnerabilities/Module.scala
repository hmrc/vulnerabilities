...
import uk.gov.hmrc.vulnerabilities.scheduler.{ReloadScheduler, TimelineScheduler, RemoveOldReportsScheduler, FixNotScannedScheduler}
...
class Module extends play.api.inject.Module:
  ...
  override def bindings(environment: Environment, configuration: Configuration): Seq[Binding[_]] =
    ...
    , bind[RemoveOldReportsScheduler].toSelf.eagerly()
